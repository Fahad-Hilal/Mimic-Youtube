...
public class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a list of {@link Video} objects.
     */
    public static ArrayList<Video> fetchEarthquakeData(String requestUrl) {
        ...
        videos= extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<Video> extractFeatureFromJson(String videoJson)
    {
...
//            prevPageToken=null;
            ...
            for (int i = 0; i < VideoArray.length(); i++) {
                ...
                videos.add(new Video(id,title,url,description,"FullTimeDEVILS"));
